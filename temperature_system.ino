...
// ============================================================================
// НОВЫЕ ГЛОБАЛЬНЫЕ ПЕРЕМЕННЫЕ ДЛЯ ЭНКОДЕРА
// ============================================================================
QueueHandle_t eventQueue = NULL;        // Очередь событий энкодера (инициализируется в initFreeRTOSObjects)
uint8_t systemState = 0;                // Текущее состояние интерфейса: 0=STATE_MAIN, 1=STATE_MODE